...
public class AdminLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminloin);
        //getSupportActionBar().hide();

        getSupportActionBar().setTitle("Nanies/Nurse Login");
        ...
        tv_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AdminLoginActivity.this, NanniNurseRegistrationActivity.class);
    ...
    private void submitData(){
        ...
        Call<ResponseData> call = service.nanies_nurse_login(str,str1);
